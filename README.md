About pytest-lazy-fixture-feedstock
===================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-lazy-fixture-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/TvoroG/pytest-lazy-fixture
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3282&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-lazy-fixture-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-lazy-fixture` can be installed with `conda`:
...
```
mamba install pytest-lazy-fixture
```

It is possible to list all of the versions of `pytest-lazy-fixture` available on your platform with `conda`:
...
```
mamba search pytest-lazy-fixture --channel conda-forge
```
...
mamba repoquery search pytest-lazy-fixture --channel conda-forge

# List packages depending on `pytest-lazy-fixture`:
mamba repoquery whoneeds pytest-lazy-fixture --channel conda-forge

# List dependencies of `pytest-lazy-fixture`:
mamba repoquery depends pytest-lazy-fixture --channel conda-forge
```
